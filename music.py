...
"")
        ...
        self.favorites_page = QtWidgets.QWidget()
        self.favorites_page.setObjectName("favorites_page")
        self.label_10 = QtWidgets.QLabel(self.favorites_page)
...
"background-color: rgab(255, 255, 255, 0);")
        ...
        self.favorites_listWidget = QtWidgets.QListWidget(self.favorites_page)
        self.favorites_listWidget.setGeometry(QtCore.QRect(10, 60, 531, 291))
        font = QtGui.QFont()
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.favorites_listWidget.setFont(font)
        self.favorites_listWidget.viewport().setProperty("cursor", QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.favorites_listWidget.setStyleSheet("color: rgb(86, 227, 194);\n"
"background-color: rgba(0, 0, 0, 100);\n"
"\n"
"selection-background-color: rgb(255, 140, 64);\n"
"selection-color: rgb(255, 255, 255);\n"
"padding:10px;\n"
"")
        self.favorites_listWidget.setVerticalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.favorites_listWidget.setHorizontalScrollBarPolicy(QtCore.Qt.ScrollBarAlwaysOff)
        self.favorites_listWidget.setObjectName("favorites_listWidget")
        self.delete_selected_favourite_btn = QtWidgets.QPushButton(self.favorites_page)
...
"border-radius:5px;")
        ...
        self.delete_all_favorites_btn = QtWidgets.QPushButton(self.favorites_page)
        self.delete_all_favorites_btn.setGeometry(QtCore.QRect(480, 20, 33, 32))
        self.delete_all_favorites_btn.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.delete_all_favorites_btn.setStyleSheet("background-color: rgb(255, 255, 255);\n"
"border-radius:5px;")
        self.delete_all_favorites_btn.setText("")
        self.delete_all_favorites_btn.setIcon(icon14)
        self.delete_all_favorites_btn.setIconSize(QtCore.QSize(32, 32))
        self.delete_all_favorites_btn.setObjectName("delete_all_favorites_btn")
        self.stackedWidget.addWidget(self.favorites_page)
...
"border-radius:15px;")
        ...
        self.favorites_btn = QtWidgets.QPushButton(self.frame_7)
        self.favorites_btn.setMinimumSize(QtCore.QSize(0, 35))
        font = QtGui.QFont()
        font.setPointSize(11)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.favorites_btn.setStyleSheet("background-color: rgb(255, 140, 64);\n"
"border-radius:15px;")
        self.favorites_btn.setObjectName("favorites_btn")
        self.horizontalLayout_5.addWidget(self.favorites_btn)
        ...
        self.actionAdd_Selected_to_Favorites = QtWidgets.QAction(MusicApp)
        self.actionAdd_Selected_to_Favorites.setIcon(icon3)
        self.actionAdd_Selected_to_Favorites.setObjectName("actionAdd_Selected_to_Favorites")
        self.actionAdd_all_to_Favorites = QtWidgets.QAction(MusicApp)
        self.actionAdd_all_to_Favorites.setIcon(icon3)
        self.actionAdd_all_to_Favorites.setObjectName("actionAdd_all_to_Favorites")
        ...
        self.actionRemove_All_favorites = QtWidgets.QAction(MusicApp)
        self.actionRemove_All_favorites.setIcon(icon14)
        self.actionRemove_All_favorites.setObjectName("actionRemove_All_favorites")
    ...
    def retranslateUi(self, MusicApp):
        ...
        MusicApp.setWindowTitle(_translate("MusicApp", "MBeats"))
        self.label.setText(_translate("MusicApp", "M Beats"))
        ...
        self.add_to_fav_btn.setText(_translate("MusicApp", "Add to Favorites"))
        ...
        self.actionAdd_Selected_to_Favorites.setText(_translate("MusicApp", "Add Selected to Favorites"))
        self.actionAdd_all_to_Favorites.setText(_translate("MusicApp", "Add all to Favorites"))
        ...
        self.actionRemove_All_favorites.setText(_translate("MusicApp", "Remove All"))
